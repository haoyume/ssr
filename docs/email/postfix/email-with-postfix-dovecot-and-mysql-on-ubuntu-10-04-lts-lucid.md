...
alias: ['email/postfix/dovecot-mysql-ubuntu-10-04-lucid/']
modified: Monday, May 13th, 2013
modified_by:
  name: Linode
...
[![Setting the root password for MySQL on a Linode.](/docs/assets/68-postfix-courier-mysql-01-mysql-root-password.png)](/docs/assets/68-postfix-courier-mysql-01-mysql-root-password.png)
...
[![Selecting the Postfix mail server configuration type on an Ubuntu 10.04 (Lucid) Linode.](/docs/assets/69-postfix-courier-mysql-02-mail-server-type-2.png)](/docs/assets/69-postfix-courier-mysql-02-mail-server-type-2.png)
...
[![Selecting the Postfix system mail name on an Ubuntu 10.04 (Lucid) Linode.](/docs/assets/70-postfix-courier-mysql-02-mail-server-type-3.png)](/docs/assets/70-postfix-courier-mysql-02-mail-server-type-3.png)
