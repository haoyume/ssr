...
[![Setting the root password for MySQL on a Linode.](/docs/assets/71-postfix-courier-mysql-ubuntu-10-10-01-mysql-root-password.png)](/docs/assets/71-postfix-courier-mysql-ubuntu-10-10-01-mysql-root-password.png)
...
[![Selecting the Postfix mail server configuration type on an Ubuntu 10.10 (Maverick) Linode.](/docs/assets/72-postfix-courier-mysql-02-mail-server-type-2.png)](/docs/assets/72-postfix-courier-mysql-02-mail-server-type-2.png)
...
[![Selecting the Postfix system mail name on an Ubuntu 10.10 (Maverick) Linode.](/docs/assets/73-postfix-courier-mysql-02-mail-server-type-3.png)](/docs/assets/73-postfix-courier-mysql-02-mail-server-type-3.png)
