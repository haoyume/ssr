...
alias: ['email/postfix/gateway-ubuntu-10-10-maverick/']
...
[![Selecting the Postfix mail server configuration type on a Ubuntu 10.04 (Maverick) system.](/docs/assets/83-postfix-courier-mysql-02-mail-server-type-2.png)](/docs/assets/83-postfix-courier-mysql-02-mail-server-type-2.png)
...
[![Selecting the Postfix system mail name on a Ubuntu 10.04 (Maverick) system.](/docs/assets/84-postfix-courier-mysql-02-mail-server-type-3.png)](/docs/assets/84-postfix-courier-mysql-02-mail-server-type-3.png)
