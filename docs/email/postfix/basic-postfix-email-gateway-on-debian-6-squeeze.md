...
[![Selecting the Postfix mail server configuration type.](/docs/assets/77-postfix-courier-mysql-02-mail-server-type-2.png)](/docs/assets/77-postfix-courier-mysql-02-mail-server-type-2.png)
...
[![Selecting the Postfix system mail name.](/docs/assets/78-postfix-courier-mysql-02-mail-server-type-3.png)](/docs/assets/78-postfix-courier-mysql-02-mail-server-type-3.png)
