...
alias: ['lemp-guides/ubuntu-10-04-lucid/','websites/lemp/lemp-server-on-ubuntu-10-04-lucid/']
...
[![Setting the MySQL root password in Ubuntu 10.04 Lucid.](/docs/assets/66-lucid-01-mysql-root-password.png)](/docs/assets/66-lucid-01-mysql-root-password.png)
