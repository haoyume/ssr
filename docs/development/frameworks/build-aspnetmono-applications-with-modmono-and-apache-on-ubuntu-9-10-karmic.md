...
We recommend using name-based virtual hosts for web hosting. Refer to the Apache documentation for [setting up Name-based virtual hosts](/docs/web-servers/apache/installation/ubuntu-9.10-karmic#configure_apache_for_named_based_virtual_hosting).
